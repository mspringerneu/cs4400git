...
;; new tests
(test (run "{with x 5 {cons x x}}") =error> "bad `with' syntax in (with x 5 (cons x x))")
(test (run "{with {x 5} {* x {with {x 3} x}}}") => 15)
(test (run "{with {x 5} {* x {with {y 3} x}}}") => 25)
(test (run "{with {x 12} {/ x {with {x 3} x}}}") => 4)
(test (run "{with {x 12} {/ x {with {y 3} x}}}") => 1)
(test (run "{with {x 12} {try {/ x y {with {y 3} {x 4}}}}}") =error> "bad syntax in (try (/ x y (with (y 3) (x 4))))")